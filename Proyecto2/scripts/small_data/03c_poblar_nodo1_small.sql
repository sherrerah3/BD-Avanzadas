-- ===========================================
-- SMALL DATA — NODO 1 (Coordinador)
-- Ejecutar SOLO desde el Query Tool del Nodo 1
--
-- usuarios:    1.000
-- ordenes:     5.000  → enrutadas automáticamente a los 3 nodos vía FDW
-- order_items: 15.000 → enrutados automáticamente a los 3 nodos vía FDW
-- ===========================================
